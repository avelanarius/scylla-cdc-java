...
public class MockRawChange implements RawChange, Comparable<MockRawChange> {
    ...
    @Override
    public int compareTo(MockRawChange other) {
        int cmpId = getId().compareTo(other.getId());
        return cmpId != 0 ? cmpId : Integer.compare(getBatchSequenceNumber(), other.getBatchSequenceNumber());
    }
}
